        ...
        <div style="text-align: left;">
            <div v-for="star in filteredStars" :key="star.id" class="card">
                ...
                <textarea
                  ...
                  @input="changeDesc(star, $event)"
                  :value="star.meta ? star.meta.description : star.description"
                >
                </textarea>
                ...
                <button
                  v-if="star.meta && star.meta.edited === true"
                  @click="saveDesc(star)"
                >
                  Сохранить
                </button>
...
<script>
    import {githubStars, githubStarsAddDesc} from '../http/backend'
    ...
    export default {
        ...
        components: {},
        created() {
            githubStars({username: 'pilot114'}).then(res => {
                if (res.data.result) {
